...
namespace ModSistema.Seguridad
{
    ...
    public class Gestion
    {
        ...
        static public bool SolicitarClave(OOB.LibSistema.Permiso.Ficha ficha)
        {
            var rt = true;
            if (ficha.IsHabilitado)
            {
                if (ficha.NivelSeguridad != OOB.LibSistema.Permiso.Enumerados.EnumNivelSeguridad.Niguna)
                {
                    var nivel = Seguridad.Enumerados.Nivel.SinDefinir;
                    switch (ficha.NivelSeguridad)
                    {
                        case OOB.LibSistema.Permiso.Enumerados.EnumNivelSeguridad.Maxima:
                            nivel = Seguridad.Enumerados.Nivel.Maximo;
                            break;
                        case OOB.LibSistema.Permiso.Enumerados.EnumNivelSeguridad.Media:
                            nivel = Seguridad.Enumerados.Nivel.Medio;
                            break;
                        case OOB.LibSistema.Permiso.Enumerados.EnumNivelSeguridad.Minima:
