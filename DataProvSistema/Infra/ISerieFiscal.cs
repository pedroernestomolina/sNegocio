...
namespace DataProvSistema.Infra
{
    ...
    {
        OOB.ResultadoLista<OOB.LibSistema.SerieFiscal.Entidad.Ficha> 
            SerieFiscal_GetLista(OOB.LibSistema.SerieFiscal.Lista.Filtro filtro);
        OOB.ResultadoEntidad<OOB.LibSistema.SerieFiscal.Entidad.Ficha> 
            SerieFiscal_GetFicha_ById(string id);
        OOB.ResultadoAuto 
            SerieFiscal_AgregarFicha(OOB.LibSistema.SerieFiscal.Agregar.Ficha ficha);
        OOB.Resultado 
